	...
	<div class="container col pt-3">
		<div class="row">
			...
			<div class="col">
				...
				<p class="">
					Số Lượng
					<button onclick="decrement()" style="width: 35px; height: 35px">
						<span>-</span>
					</button>
					<input class="text-center" id="SoLuongMua" maxlength="3"
						type="text" pattern="[0-9]{3}" value="1"
						style="width: 35px; height: 35px">
					<button onclick="increment()" style="width: 35px; height: 35px">
						<span>+</span>
					</button>
				</p>
				<div class="text-center row">
					<button class="text-center col">mua</button>

				</div>
				<div class="text-center row">
					<button class="text-center col">Thêm Vào Giỏ Hàng</button>
					<button class="text-center col">Nhận Thông Tin Tư Vấn</button>

				</div>
				<div class="text-center row">
					<p class="text-center col">Miễn phí vận chuyển tại TP.HCM</p>
					<p class="text-center col">Bảo hành chính hãng toàn quốc</p>
		...
		<div class="row">
			...
			<h4><span class="me-3"> Mô tả sản phẩm</span>  <span>Hướng dẫn mua hàng</span></h4>
			<hr>
			<p><%=p.getStatus()%></p>
			</div>
			<div class="col-5">
