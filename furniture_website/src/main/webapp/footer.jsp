...
.dot li {
	padding-left: 20px;
	/* Tạo khoảng trắng để đặt dấu chấm hoặc biểu tượng */
	position: relative;
}

.dot li::before {
	content: '\2022'; /* Dấu chấm • Unicode */
	color: #ff0000; /* Màu của dấu chấm */
	font-size: 1.5em; /* Kích thước của dấu chấm */
	position: absolute;
	left: 0;
	top: 50%;
...
<body>
	<footer class="  bg-dark  white_text" data-bs-theme="light">
		<div class="py-5 container-xl ">
			<div class="row">
				<!-- thong tin shop -->
				<div class="col-6 col-md-3 mb-3 white_text">
					<h5 class=" white_text"%>>FURNITURE WEB</h5>
					...
					<div
						...
						<ul class="list-unstyled d-flex">
							<li class="ms-1"><a class="link-body-emphasis m-2" href="#">
				...
				<!-- chính sách của shop -->
				<div class="col-5 col-md-2 mb-3 white_text dot">
					<h5>Chính sách</h5>
					<ul class="nav flex-column">
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/ChinhSach/thanhVien.html"
							class="nav-link p-0 white_text">Chính sách thành viên</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/ChinhSach/thanhToan.html"
							class="nav-link p-0 white_text">Chính sách thanh toán</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/ChinhSach/doiSanPham.html"
							class="nav-link p-0 white_text">Chính sách đổi sản phẩm</a></li>
						<li class="nav-item mb-2"><a
							href=" huongDan_chinhSach/ChinhSach/baoMat.html"
							class="nav-link p-0 white_text">Chính sách bảo mật</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/ChinhSach/congTacVien.html"
							class="nav-link p-0 white_text">Chính sách cộng tác viên</a></li>
					</ul>
				</div>

				<!-- hướng dãn của shop -->
				<div class="col-5 col-md-2 mb-3 dot">
					<h5>HƯỚNG DẪN</h5>
					<ul class="nav flex-column ">
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/HuongDan/muaHang.html"
							class="nav-link p-0 white_text">Hướng dẫn mua hàng</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/HuongDan/DoiTra.html"
							class="nav-link p-0 white_text">Hướng dẫn đổi trả</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/HuongDan/thanhToan.html"
							class="nav-link p-0 white_text">Hướng dẫn thanh toán</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/HuongDan/congTacVien.html"
							class="nav-link p-0 white_text">Chương trình công tác viên</a></li>
						<li class="nav-item mb-2"><a
							href="huongDan_chinhSach/HuongDan/GiaiDapThacMac.html"
				...
				<div class="col-md-4 offset-md-1 mb-3">
					<form>
						...
						<div>
							...
							<div
								class="d-flex flex-column flex-sm-row justify-content-between py-4  container-x pay ">
								<ul class="list-unstyled d-flex ">
									<li class="ms-1"><a class="link-body-emphasis m-2"
										href="#"><img class="w-auto   " alt=""
											src="img/img_larg/payment_1.webp"></a></li>

									<li class="ms-1"><a class="link-body-emphasis m-2"
										href="#"><img class="w-auto  " alt=""
											src="img/img_larg/payment_2.webp"></a></li>

									<li class="ms-1"><a class="link-body-emphasis m-2"
										href="#"><img class="w-auto  " alt=""
											src="img/img_larg/payment_3.webp"></a></li>

									<li class="ms-1"><a class="link-body-emphasis m-2"
										href="#"><img class="w-auto " alt=""
											src="img/img_larg/payment_4.webp"></a></li>
