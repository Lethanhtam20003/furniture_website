...
public class PhanTrang extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "":
			...
			break;
		case "fillter":
			fillter(session, request, response);
			break;
	...
	private void phanTrang(HttpSession session, HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("listProductThenFillter") != null) {
			session.removeAttribute("listProductThenFillter");
		}
	...
	private void fillter(HttpSession session, HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		List<Product> dangSach = (ArrayList<Product>) session.getAttribute("listProductThenFillter");
