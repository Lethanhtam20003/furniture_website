...
public class Factory {
	...
	public static Product createProduct(String id, String productName, String categoryID, String groupID,
			...
			String thickness, String space, String design, String timeToUse, String imgPath, String couponID,Date dateAdded) {
		...
		if (type.equalsIgnoreCase("decoration")) {
			...
			p = new ProDecorativeLights(id, productName, categoryID, groupID, producer, price, type, decription,
					quallityInStorageThen, status, space, brandOrigin, meterial, size, wattage, imgPath, couponID,dateAdded);
			...
			p = new ProFurniture(id, productName, categoryID, groupID, producer, price, type, decription,
					quallityInStorageThen, status, brandOrigin, meterial, color, size, thickness, imgPath, couponID,dateAdded);
		}
		if (p != null)
